 ...
 * The purpose of this class is to pre-load my database mechanism (which is for now just using Java/
 * Android File database) with the data that I want to preload.
 *
